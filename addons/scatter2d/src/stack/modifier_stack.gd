...
func add(modifier: ScatterModifierBase) -> void:
...
func remove(modifier: ScatterModifierBase) -> void:
...
func duplicate_modifier(modifier: ScatterModifierBase) -> void:
...
func get_index(modifier: ScatterModifierBase) -> int:
